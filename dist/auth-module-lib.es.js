...
function ir() {
  if (Re)
    return j;
  Re = 1;
  var N = Oe, P = Symbol.for("react.element"), M = Symbol.for("react.fragment"), _ = Object.prototype.hasOwnProperty, D = N.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, F = { key: !0, ref: !0, __self: !0, __source: !0 };
  function S(h, l, R) {
...
var sr = H.exports;
const lr = () => /* @__PURE__ */ sr.jsx("button", { children: "submit = ssss fgagsa" });
export {
  lr as MyButton
};
